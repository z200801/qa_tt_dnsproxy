#!/usr/bin/env python
#
# Copied from https://question-it.com/questions/1888713/dns-server-python
# Use circuits https://pypi.org/project/circuits/
...
class App(Component):
    ...
    def init(self, bind=("0.0.0.0", 15353), server="192.168.1.3", port=53,
             verbose=False):
